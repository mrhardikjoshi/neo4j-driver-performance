...
delete_all_nodes
write_multi_transaction(10_000, header_logger: true)
delete_all_nodes
write_multi_transaction(10_000)
delete_all_nodes
write_multi_transaction(10_000)
read_multi_transaction(5, header_logger: true)
read_multi_transaction(5)
read_multi_transaction(5)
delete_all_nodes
write_single_transaction(10_000, header_logger: true)
delete_all_nodes
write_single_transaction(10_000)
delete_all_nodes
write_single_transaction(10_000)
read_single_transaction(5, header_logger: true)
read_single_transaction(5)
read_single_transaction(5)
delete_all_nodes

# for 50_000 records write and read (read 1k time looped)
write_multi_transaction(50_000, header_logger: true)
delete_all_nodes
...
read_multi_transaction(5)
delete_all_nodes
write_single_transaction(50_000, header_logger: true)
delete_all_nodes
